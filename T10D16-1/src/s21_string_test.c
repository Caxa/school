...
int main() {
    ...
    #endif
    #ifdef Quest_2
        s21_strcmp_test("School 21", "School 42");
        s21_strcmp_test("", "ABC");
    ...
    #endif
    #ifdef Quest_7
        char str_tok[] = "This is not bug, this ficha.";
...
void s21_strlen_test(const char *test_str) {
    ...
    printf("Test Result: %s\n\n", (expected_length == s21_strlen(test_str)) ? "SUCCESS " : "FAIL ");
}
